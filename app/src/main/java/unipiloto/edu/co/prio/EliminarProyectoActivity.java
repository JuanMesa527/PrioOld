...
public class EliminarProyectoActivity extends AppCompatActivity {
    ...
    public void mostrarProyecto() {
        List<String> proyectos = dbHelper.getAllProjects();
    ...
    public void eliminar_proyecto(View view) {
        ...
        if (idText.isEmpty() ) {
            Toast.makeText(this, "Por favor, complete el id del proyecto", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (eliminado) {
            ...
            Intent intent = new Intent(EliminarProyectoActivity.this, ManageProyectActivity.class);
